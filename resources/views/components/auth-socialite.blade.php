@props(['providers' => ['google', 'facebook', 'twitter']])
...
<div class="mt-6">
    ...
    <div class="mt-6 grid grid-cols-3 gap-3">
        @foreach($providers as $provider)
            <div>
                <a href="{{ route('socialite.redirect', ['provider' => $provider]) }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-all duration-200 hover:shadow-md">
                    <span class="sr-only">Sign in with {{ ucfirst($provider) }}</span>
